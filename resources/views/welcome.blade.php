...
<html lang="en">
  <head>
    ...
    <title>ProLearn_Main</title>

    <!-- Page Title Logo -->
    <link rel="icon" href="../img/ProLearn-onlylogo2.png" type="image/png" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Playwrite+HR:wght@100..400&family=Playwrite+HU:wght@100..400&display=swap" rel="stylesheet"/>
...
header {
    background-color: transparent; /* Transparent background for floating effect */
    color: white;
    padding: 0;
    position: fixed;
    top: 10px; /* Slightly lower to create floating effect */
    width: 100%;
...
.navbar {
    ...
    align-items: center;
    padding: 20px 30px;
    background-color: var(--main-color); /* Ensure navbar background color remains the same */
    border-radius: 50px; /* Elongated capsule shape */
    /* box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); Floating effect with shadow */
    /* max-width: 100%; Restrict width for floating effect */
    width: calc(100% - 80px); /* Almost full width, with some margin */
    height: 80px;
...
/* Change magnifier icon color to black */
...
@media (max-width: 1234px) {
    ...
    .navbar {
        padding: 20px 30px; /* Keep the padding consistent */
        width: calc(100% - 60px); /* Keep the same width */
        height: 80px; /* Ensure height remains the same */
    }
    .navbar-toggle {
        display: block;
    }
...
@media (max-width: 800px) {
    ...
    .navbar {
        padding: 20px 30px; /* Keep the padding consistent */
        width: calc(100% - 30px); /* Keep the same width */
        height: 80px; /* Ensure height remains the same */
    }
    .navbar-toggle {
        display: block;
...
.search-container .search-input{
    ...
    .search-input-container {
        display: none;
        position: absolute;
        top: 60px; /* Position the input below the navbar */
        left: 0;
        width: 100%;
...
.slide-menu a {
    ...
    text-decoration: none;
    font-size: 25px;
    color: var(--main-color); /* Changed to red */
    display: block;
    transition: 0.3s;
    border-bottom: 1px solid var(--main-color); /* Changed to red */
}

.slide-menu a:hover {
    background-color: var(--main-color); /* Changed to red */
...
.slide-menu .closebtn {
    ...
    color: var(--main-color); /* Red color */
    cursor: pointer;
...
@keyframes scrollLeft {
  to {
    left: -400px; /* Adjusted for new item width */
  }
}

@keyframes scrollRight {
  to {
    right: -400px; /* Adjusted for new item width */
  }
}
...
img {
  width: 100%;
  height: 100%;
  object-cover: cover; /* Ensures the image covers the container without distortion */
}
/* course corousel ends */
    ...
    <!-- Alpine.js CDN (if needed for interactivity) -->
    <script
      defer
  ...
  <body style="background-color: #7c3aed">
    <header>
      <nav class="navbar">
        ...
        <!-- <div class="search-container flex items-center bg-white h-12 rounded-full px-6 cursor-pointer custom-shadow">
            <input type="text" name="search" placeholder="Search..." class="search-input bg-transparent text-gray-800 border-none outline-none font-medium text-base transition-all duration-800 ease-in-out w-80">
            <a href="#" class="search-btn text-black ml-4">
        ...
        <ul class="navbar-nav">
          <li class="dropdown">
            <a href="#" class="dropdown-toggle font-medium">Get Started</a>

          </li>
          <li class="dropdown">
            <a href="{{ route('register') }}" class="dropdown-toggle font-medium"
              >Register for Online Classes</a
            >

          </li>

          <li><a class="font-medium" href="#about">About</a></li>
          <li><a class="font-medium" href="#contact">Contact Us</a></li>
        </ul>
        <div class="navbar-profile font-bold text-lg">
            @auth
            <a
                href="{{ url('/dashboard') }}"
                class="bg-purple-950 hover:bg-purple-900 transition-colors duration-300 ease-in-out px-5 py-4 rounded-xl text-center content-center justify-center"
            >
                Dashboard
            </a>
        @else
            ...
            @if (Route::has('register'))
                <a
                    href="{{ route('register') }}"
                    class="text-white hover:bg-purple-800 transition-colors duration-300 px-5 py-4 rounded-xl text-center content-center justify-center"
                >
                    Register
                </a>
            @endif
    ...
    <div id="slideMenu" class="slide-menu">
      ...
      <div class="dropdown">
        <a
          ...
          onclick="toggleDropdown('getStartedDropdown')"
          >Get Started</a
        >
        <div id="getStartedDropdown" class="dropdown-container">
          <a href="#">Apply to ProLearn</a>
      ...
      <div class="dropdown">
        <a
          href="javascript:void(0)"
          class="dropdown-toggle"
          onclick="toggleDropdown('registerDropdown')"
          >Register for Online Classes</a
        >
        <div id="registerDropdown" class="dropdown-container">
          <a href="#">How to Register</a>
          <a href="#">Important Dates</a>
          <a href="#">Class Schedules</a>
          <a href="#">StudentPortal Acc</a>
        </div>
      </div>
      <div class="dropdown">
        <a
          href="javascript:void(0)"
          class="dropdown-toggle"
          onclick="toggleDropdown('headquarterDropdown')"
          >Headquarter</a
        >
        <div id="headquarterDropdown" class="dropdown-container">
          <a href="#">Admissions & Records/Registration</a>
          <a href="#">Noncredit Admissions/Registration</a>
          <a href="#">Assessment Center</a>
          <a href="#">Outreach & Recruitment</a>
        </div>
      </div>
    ...
    <div class="relative w-full h-screen">
      <iframe
        style="top: 105px"
        class="absolute left-0 w-full h-full border-none bg-cover bg-center bg-no-repeat"
        src="https://my.spline.design/interactiveaistartupheropagecopy-be0f27129b72de2e3327c4ed83c81faa/"
        frameborder="0"
        width="100%"
        height="100%"
      ></iframe>
      <!-- <iframe src='https://my.spline.design/interactiveaistartupheropagecopy-be0f27129b72de2e3327c4ed83c81faa/' frameborder='0' width='100%' height='100%'></iframe> -->
    </div>

    <!-- watermark remover -->
    <div style="position: absolute; background-color: #a584ff; width: 8.85rem; height: 2.25rem; top: 779px; right: 1.15rem;"></div>

    <!-- After hero section -->
    <div class="py-12 bg-white pt-60">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center">
              <h2 class="text-base font-semibold text-pink-500 tracking-wide uppercase opacity-0 transition-opacity duration-10000">Services</h2>
              <h3 class="mt-2 text-6xl leading-10 font-extrabold tracking-tight text-gray-900 sm:text-5xl opacity-0 transition-opacity duration-10000"
              style="font-family: Josefin Sans, sans-serif; font-optical-sizing: auto;">
                  What’s Services We Provide
              </h3>
          </div>

          <div class="mt-20">
              <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                  <div class="pt-6 opacity-0 transition-opacity duration-10000">
                      <div class="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                          <div class="-mt-6">
                              <div>
                                  <span class="inline-flex items-center justify-center p-3 bg-purple-100 rounded-md shadow-lg">
                                    <svg class="h-10 w-10 text-purple-600" fill="currentColor" viewBox="0 0 24 24">
                                      <path d="M12 2L1 9l11 7 11-7-11-7zm0 13.15L3.9 10.3 12 6.85l8.1 3.45-8.1 4.85zm0 2.85L5 13v3.5l7 4.5 7-4.5V13l-7 5z"></path>
                                    </svg>
                                  </span>
                              </div>
                              <h3 class="mt-8 text-lg leading-6 font-medium text-gray-900">Personalized Learning Path Development</h3>
                              <p class="mt-5 text-base text-gray-500">
                                Tailored learning plans based on individual interests, skills, and career goals.
                              </p>
                              <a href="#" class="mt-3 text-purple-600 hover:underline inline-flex items-center">
                                  Learn More <svg class="ml-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                      <path d="M12.293 9.293a1 1 0 011.414 0L17 12.586V10a1 1 0 112 0v5a1 1 0 01-1 1h-5a1 1 0 110-2h2.586l-3.293-3.293a1 1 0 010-1.414z"></path>
                                  </svg>
                              </a>
                          </div>
                      </div>
                      ...
                      <div class="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                          <div class="-mt-6">
                              <div>
                                  <span class="inline-flex items-center justify-center p-3 bg-purple-100 rounded-md shadow-lg">
                                    <svg class="h-10 w-10 text-purple-600" fill="currentColor" viewBox="0 0 24 24">
                                      <path d="M12 2a5 5 0 100 10 5 5 0 000-10zm0 14c-6 0-10 3-10 6v2h20v-2c0-3-4-6-10-6z"></path>
                                    </svg>
                                  </span>
                              </div>
                              <h3 class="mt-8 text-lg leading-6 font-medium text-gray-900">Teacher Empowerment</h3>
                              <p class="mt-5 text-base text-gray-500">
                                Empowering teachers with easy-to-use tools and a supportive community.
                              </p>
                              <a href="#" class="mt-3 text-purple-600 hover:underline inline-flex items-center">
                                  Learn More <svg class="ml-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                      <path d="M12.293 9.293a1 1 0 011.414 0L17 12.586V10a1 1 0 112 0v5a1 1 0 01-1 1h-5a1 1 0 110-2h2.586l-3.293-3.293a1 1 0 010-1.414z"></path>
                      ...
                      <div class="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                          <div class="-mt-6">
                              <div>
                                  <span class="inline-flex items-center justify-center p-3 bg-purple-100 rounded-md shadow-lg">
                                    <svg class="h-10 w-10 text-purple-600" fill="currentColor" viewBox="0 0 24 24">
                                      <path d="M16 6V4c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v2H6v14h12V6h-2zm-6-2h4v2h-4V4zm6 14H8v-8h8v8z"></path>
                                    </svg>
                                  </span>
                              </div>
                              <h3 class="mt-8 text-lg leading-6 font-medium text-gray-900">Career Building</h3>
                              <p class="mt-5 text-base text-gray-500">
                                Personalized guidance and mentorship to help students achieve their career aspirations.
                              </p>
                              <a href="#" class="mt-3 text-purple-600 hover:underline inline-flex items-center">
                                  Learn More <svg class="ml-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                      <path d="M12.293 9.293a1 1 0 011.414 0L17 12.586V10a1 1 0 112 0v5a1 1 0 01-1 1h-5a1 1 0 110-2h2.586l-3.293-3.293a1 1 0 010-1.414z"></path>
  ...
  <!-- Companies -->
  <section class="bg-white h-4/5 w-full flex justify-center items-center p-20">
    <div class="flex flex-col justify-center">
      <div class="text-xl text-center text-semibold text-gray-700 py-12">Partnered with
        <span class="text-indigo-600 font-bold">2000+</span> companies worldwide
      </div>
            ...
            <a class="flex items-center lg:justify-center" target="_blank">
                <svg class="h-9 hover:text-gray-900 " viewBox="0 0 137 37" fill="currentColor"
                    ...
                    <path
                        ...
                        fill="currentColor"></path>
                    <path d="M74.9258 25.0783H78.8688V10.9255H74.9258V25.0783Z" fill="currentColor"></path>
                    <path
            ...
            <a class="flex items-center lg:justify-center" target="_blank">
                <svg class="h-6 hover:text-gray-900" viewBox="0 0 124 21" fill="currentColor"
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        fill="currentColor"></path>
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M102.844 0.069519H107.554V20.2025H102.844V0.069519Z" fill="currentColor"></path>
                    <path fill-rule="evenodd" clip-rule="evenodd"
...
<!-- Stats -->
<section class="bg-gradient-to-r from-white via-gray-200 to-white py-24 sm:py-32">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:max-w-none">
      <div class="text-center space-y-4">
        <h2 class="text-3xl font-bold tracking-tight text-gray-800 sm:text-4xl">Trusted by students worldwide</h2>
        <p class="text-lg leading-8 text-violet-950">We can help you grow your educational and career path, no matter the
          where u are.
        </p>
      </div>
      <dl class="mt-16 grid grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-2 lg:grid-cols-4">
        <div class="flex flex-col bg-gray-600 bg-opacity-5 p-8">
          <dt class="text-sm font-semibold leading-6 text-gray-800">Students joined in 2023</dt>
          <dd class="order-first text-3xl font-semibold tracking-tight text-black">100K</dd>
        </div>
        <div class="flex flex-col bg-gray-600 bg-opacity-5 p-8">
          <dt class="text-sm font-semibold leading-6 text-gray-800">Tutorials uploaded daily</dt>
          <dd class="order-first text-3xl font-semibold tracking-tight text-black">10K</dd>
        </div>
        <div class="flex flex-col bg-gray-600 bg-opacity-5 p-8">
          <dt class="text-sm font-semibold leading-6 text-gray-800">Hourly visitors</dt>
          <dd class="order-first text-3xl font-semibold tracking-tight text-black">6.6K</dd>
        </div>
        <div class="flex flex-col bg-gray-600 bg-opacity-5 p-8">
          <dt class="text-sm font-semibold leading-6 text-gray-800">Career opportunities</dt>
          <dd class="order-first text-3xl font-semibold tracking-tight text-black">23K</dd>
        </div>
      </dl>
    </div>
  </div>
    ...
    <!-- Course Showcase -->
    <!-- component -->
    <section class="course-carousel bg-white pt-16 pb-24 sm:py-32">
      <div class="text-center">
        <h2 class="text-base font-semibold text-pink-500 tracking-wide uppercase">Courses</h2>
        <h3 class="mt-2 text-6xl  pb-10 leading-10 font-extrabold tracking-tight text-gray-900 sm:text-5xl"
        style="font-family: Josefin Sans, sans-serif; font-optical-sizing: auto;">
            Meet Our Top-Rated Courses
        </h3>
      </div>
      <div class="wrapper">
          <div class="itemLeft item1">
              <img src="{{asset('storage/courseHomeImage/c1.webp')}}" alt="Image 1">
          </div>
          <div class="itemLeft item2">
              <img src="{{asset('storage/courseHomeImage/c2.webp')}}" alt="Image 2">
          </div>
          <div class="itemLeft item3">
              <img src="{{asset('storage/courseHomeImage/c3.webp')}}" alt="Image 3">
          </div>
          <div class="itemLeft item4">
              <img src="{{asset('storage/courseHomeImage/c4.webp')}}" alt="Image 4">
          </div>
          <div class="itemLeft item5">
              <img src="{{asset('storage/courseHomeImage/c5.webp')}}" alt="Image 5">
          </div>
          <div class="itemLeft item6">
              <img src="{{asset('storage/courseHomeImage/c6.webp')}}" alt="Image 6">
          </div>
          <div class="itemLeft item7">
              <img src="{{asset('storage/courseHomeImage/c7.webp')}}" alt="Image 7">
          </div>
          <div class="itemLeft item8">
              <img src="{{asset('storage/courseHomeImage/c8.webp')}}" alt="Image 8">
          </div>
      </div>
      <div class="wrapper mb-8">
          <div class="itemRight item1">
              <img src="{{asset('storage/courseHomeImage/c9.webp')}}" alt="Image 9">
          </div>
          <div class="itemRight item2">
              <img src="{{asset('storage/courseHomeImage/c10.webp')}}" alt="Image 10">
          </div>
          <div class="itemRight item3">
              <img src="{{asset('storage/courseHomeImage/c11.webp')}}" alt="Image 11">
          </div>
          <div class="itemRight item4">
              <img src="{{asset('storage/courseHomeImage/c12.webp')}}" alt="Image 12">
          </div>
          <div class="itemRight item5">
              <img src="{{asset('storage/courseHomeImage/c13.webp')}}" alt="Image 13">
          </div>
          <div class="itemRight item6">
              <img src="{{asset('storage/courseHomeImage/c14.webp')}}" alt="Image 14">
          </div>
          <div class="itemRight item7">
              <img src="{{asset('storage/courseHomeImage/c15.webp')}}" alt="Image 15">
          </div>
          <div class="itemRight item8">
              <img src="{{asset('storage/courseHomeImage/c16.webp')}}" alt="Image 16">
          </div>
      </div>
      </section>
    ...
    <script type="module">
      ...
      // Function to update slide colors
      function updateSlideColors() {
        slides.forEach((slide, index) => {
          if (index === keenSlider.track.details.rel) {
            // Current slide
            slide.querySelector("blockquote").style.backgroundColor = "#050a44";
            slide.querySelector("p").style.color = "#fff"; // Adjust text color as necessary
          } else {
            // Non-active slides
            slide.querySelector("blockquote").style.backgroundColor = "#fff";
            slide.querySelector("p").style.color = "#333"; // Adjust text color as necessary
          }
        });
      }
    ...
    <section style="background-color: #7c3aed">
      <div
      ...
      >
        ...
        >
          <h2
            style="color: #050a44"
            class="max-w-xl text-4xl font-bold tracking-tight sm:text-5xl"
          >
          ...
          <div class="mt-8 flex gap-4 lg:mt-0">
            <button
              ...
              class="rounded-full border bg-white p-3 text-rose-600 transition hover:bg-rose-600 hover:text-white"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <div class="keen-slider__slide rounded-2xl">
              ...
              >
                <div>
                  ...
                  <div class="mt-4">
                    <p class="text-2xl font-bold text-gray-50 sm:text-2xl">
                      "As a student, ProLearn is the best virtual learning
                      environment taught by masterclass teachers around the
                      globe."
                    </p>
                  </div>
                </div>
                <img
                  class="relative top-4 object-cover h-20 w-20 rounded-full border-2 border-white"
                  src="https://i.pinimg.com/236x/ff/e5/c7/ffe5c7867c2b9529b62a529ffcc567aa.jpg"
                  alt="Profile Picture"
                />

                <footer class="mt-4 text-sm font-medium text-rose-600 sm:mt-6">
                  &mdash; Michael Scott
                </footer>
              </blockquote>
            </div>
            ...
            <div class="keen-slider__slide  rounded-2xl">
              ...
              >
                <div>
                  ...
                  <div class="mt-4">
                    <p class="text-2xl font-bold text-gray-800 sm:text-2xl">
                      "As an educator, ProLearn provides me with the perfect platform to deliver content that resonates with students of all levels."
                    </p>
                  </div>
                </div>
                <img
                  class="relative top-4 object-cover h-20 w-20 rounded-full border-2 border-white"
                  src="https://i.pinimg.com/564x/82/18/1f/82181f1d36fb0eaba87bf3ff8c1d54d0.jpg"
                  alt="Profile Picture"
                />
            ...
            <div class="keen-slider__slide  rounded-2xl">
              ...
              >
                <div>
                  ...
                  <div class="mt-4">
                    <p class="text-2xl font-bold text-gray-800 sm:text-2xl">
                      "ProLearn's virtual learning environment has transformed my study routine, making learning interactive and engaging."
                    </p>
                  </div>
                </div>
                <img
                  class="relative top-4 object-cover h-20 w-20 rounded-full border-2 border-white"
                  src="https://i.pinimg.com/564x/e6/3a/12/e63a1274d16ece550d0886e481cad659.jpg"
                  alt="Profile Picture"
                />
            ...
            <div class="keen-slider__slide  rounded-2xl">
              ...
              >
                <div>
                  ...
                  <div class="mt-4">
                    <p class="text-2xl font-bold text-gray-800 sm:text-2xl">
                      "ProLearn's user-friendly interface allows me to focus on teaching rather than technical hurdles, enriching my classroom experience."
                    </p>
                  </div>
                </div>
                <img
                  class="relative top-4 object-cover h-20 w-20 rounded-full border-2 border-white"
                  src="https://i.pinimg.com/564x/e7/97/95/e797952bbfa591d2d1f34f2e695f73cd.jpg"
                  alt="Profile Picture"
                />
...
<!-- <div class="blog" style="background-color: white;">
  ...
  <div class="band">
    <h1 class="text-4xl text-gray-900 font-bold tracking-tight text-center sm:text-5xl">Latest News And Events</h1>
    <div class="item-1">
      <a href="https://design.tutsplus.com/articles/international-artist-feature-malaysia--cms-26852" class="card">
        ...
        <article>
          <h1>International Scholarship calling: Malaysia</h1>
...
<section id="about" class="bg-gray-100">
  <div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
      <div class="px-16 mt-24 grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          <div class="max-w-lg">
              <h2 class="text-gray-950 text-5xl font-extrabold leading-10 pb-10"
              style="font-family: 'Poppins', sans-serif; font-weight: bolder; font-optical-sizing: auto;">About Us</h2>
              <p class="mt-4 text-gray-600 text-lg">At ProLearn, we're dedicated to transforming education through innovation. Our Virtual Learning Environment (VLE) empowers students and educators with cutting-edge tools and resources designed to enhance the learning experience. By integrating advanced technologies, we aim to create a dynamic and interactive platform that fosters growth, curiosity, and success. At ProLearn, we're passionate about making education accessible, engaging, and impactful for all.</p>
              <div class="mt-8">
                  <a href="#" class="text-purple-500 hover:text-purple-600 font-medium">Learn more about us
                      <span class="ml-2">&#8594;</span></a>
              </div>
          </div>
          <div class="mt-12 md:mt-0">
              <img src="https://images.unsplash.com/photo-1531973576160-7125cd663d86" alt="About Us Image" class="object-cover rounded-lg shadow-md transition-transform duration-300 ease-in-out transform hover:scale-105">
          </div>
      </div>
  </div>
</section>
...
<!-- Contact Us -->
<section id="contact" class="bg-gray-100 pt-32 pb-14">
          ...
          <div class="lg:mb-0 mb-10">
              <div class="group w-full h-full">
                  <div class="relative h-full">
                      <img src="https://www.aus-lanka.org.au/wp-content/uploads/2021/09/handshake-13340814.jpg" alt="ContactUs tailwind section"
                          class="h-screen lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700 transition-transform duration-300 ease-in-out transform hover:scale-105" />
                      <!-- Placeholder for Text -->
                      <div class="absolute bottom-0 w-full lg:p-11 p-5"></div>
                  </div>
              </div>
          </div>
          <!-- Right Content Section -->
          <div class="py-12 mt-10 px-16">
              <h1 class="text-gray-950 text-5xl font-extrabold leading-10 pb-10"
              style="font-family: 'Poppins', sans-serif; font-weight: bolder; font-optical-sizing: auto;">Join Us! It's Free</h1>
              <p class="text-gray-600 text-lg pb-11">
                  Ready to make a difference in the world of education? Become a catalyst and reach out to
                  ProLearn VLE via phone, email, or in person, and join us on this exciting journey.
              </p>
              <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-1 md:gap-x-8 md:gap-y-10">
                  <!-- Address Section -->
                  <div class="flex">
                      <div class="flex-shrink-0">
                          <div class="flex items-center justify-center h-12 w-12 rounded-md bg-violet-600 text-white">
                              <!-- Heroicon: globe-alt -->
                  ...
                  <div class="flex">
                      ...
                      <div class="ml-4">
                          <dt class="text-lg leading-6 font-medium text-gray-900">Phone number</dt>
                          <dd class="mt-2 text-base text-gray-500">(+95) 912345 678</dd>
                      </div>
                  </div>
                  <!-- Email Section -->
                  <div class="flex">
                      ...
                      <div class="ml-4">
                          ...
                          <dd class="mt-2 text-base text-gray-500">prolearn@vle.edu.mm</dd>
                          <dd class="mt-2 text-base text-gray-500">prolearn_office@vle.edu.mm</dd>
                      </div>
                  </div>
                  ...
                  <div class="flex">
                      ...
                      <div class="ml-4">
                          <dt class="text-lg leading-6 font-medium text-gray-900">Available Hours</dt>
                          <dd class="mt-2 text-base text-gray-500">
...
<!-- CTA Container -->
<section class="bg-gray-100 overflow-hidden relative lg:flex lg:items-center">
  <div class="w-8/12 max-w-4xl py-12 px-8 sm:px-12 lg:py-16 lg:px-16 z-20">
      <h2 class="text-3xl py-10 sm:text-4xl lg:text-5xl font-extrabold font-poppins poppins-extra-bold text-black">
          <span class="block">
              Shape Your Future Today
          </span>
      </h2>
      <p class="text-md mt-4 text-gray-600 text-lg">
          "Unlock your true potential with personalized education paths tailored to your goals. Join our community of forward-thinkers and gain access to expert guidance, dynamic learning resources, and career-building opportunities. Your journey toward a successful and fulfilling future starts here—take the first step and sign up today!"
      </p>
      <div class="lg:mt-0 lg:flex-shrink-0">
          <div class="mt-12 inline-flex rounded-md shadow">
              <button type="button" class="py-2 px-5 bg-violet-600 hover:bg-purple-700 focus:ring-purple-500 focus:ring-offset-purple-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
                <a
                    href="{{ route('register') }}"
                    class="text-white px-5 py-4 rounded-xl text-center content-center justify-center"
                >
                Get started
                </a>
              </button>
  ...
  <div class="flex items-center justify-center p-4 lg:p-16 lg:w-1/2">
      <div class="grid grid-cols-2 gap-8">
          <div>
              <img src="http://pro.nrstudio.mo/wp-content/uploads/2018/03/20170619_cherrygrad-1027.jpg" class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out transform hover:scale-105" alt="Graduation"/>
          </div>
          <div class="flex flex-col gap-8">
              <img src="https://www.lehighvalleygrandprix.com/wp-content/uploads/2017/05/graduation-party.jpg" class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out transform hover:scale-105" alt="Graduation Party"/>
              <img src="https://th.bing.com/th/id/OIP.lShUNZEkqm7vq4dca1djNgHaFL?rs=1&pid=ImgDetMain" class="rounded-lg object-cover w-full h-full transition-transform duration-300 ease-in-out transform hover:scale-105" alt="Graduation Celebration"/>
          </div>
      </div>
  </div>
</section>
...
<section class="bg-gray-900">
  <div class="container max-w-3xl lg:max-w-5xl px-8 py-32 mx-auto">
    <h1 class="text-2xl font-semibold text-center text-white">
      Frequently Asked Questions
    </h1>

    <div x-data="{ openItem: null }" class="mt-12 space-y-8">
      <div class="border-2 border-gray-100 rounded-lg dark:border-gray-700">
        ...
        >
          <h1 class="font-semibold text-white">
            What are the technical requirements for participating in virtual online learning?
          </h1>
          <span
            x-show="openItem !== 1"
            class="text-white bg-blue-500 rounded-full transition-all duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-6 h-6"
          ...
          <span
            x-show="openItem === 1"
            class="text-gray-400 bg-gray-200 rounded-full transition-all duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-6 h-6"
        ...
        <p
          ...
          class="p-8 text-sm text-gray-300"
        >
          To participate in virtual online learning, you’ll need a stable internet connection, a computer or tablet with a camera and microphone, and up-to-date web browsers (like Chrome, Firefox, or Safari). Ensure you have any required software installed, such as Zoom or Microsoft Teams, and check if any specific programs or applications are needed for your course.
        </p>
      </div>
      ...
      <div class="border-2 border-gray-100 rounded-lg dark:border-gray-700">
        ...
        >
          <h1 class="font-semibold text-white">
            How do I access my online course materials and assignments?
          </h1>
          <span
            x-show="openItem !== 2"
            class="text-white bg-blue-500 rounded-full transition-all duration-200"
        ...
        <p
          ...
          class="p-8 text-sm text-gray-300"
        >
          Log in to the learning management system (LMS) using your provided credentials. Navigate to your course dashboard to find links to course materials, assignments, and other resources. Your instructor may also provide specific instructions or links in the course announcements or modules section.
        </p>
      </div>
      ...
      <div class="border-2 border-gray-100 rounded-lg dark:border-gray-700">
        ...
        <p
          ...
          class="p-8 text-sm text-gray-300"
        >
          First, try basic troubleshooting steps such as refreshing your browser or restarting your device. If issues persist, contact the technical support team via email or phone, or use the live chat feature if available. Report the issue with details about what happened and any error messages you received.
        </p>
      </div>
      ...
      <div class="border-2 border-gray-100 rounded-lg dark:border-gray-700">
        ...
        >
          <h1 class="font-semibold text-white">
            How will I be graded, and how can I track my progress?
          </h1>
          <span
            x-show="openItem !== 4"
            class="text-white bg-blue-500 rounded-full transition-all duration-200"
        ...
        <p
          ...
          class="p-8 text-sm text-gray-300"
        >
          Grading criteria are typically outlined in the course syllabus or on the LMS. Grades for assignments, quizzes, and exams will be posted in the LMS gradebook. You can monitor your progress by regularly checking the gradebook and reviewing feedback provided by your instructor.
        </p>
      </div>
      ...
      <div class="border-2 border-gray-100 rounded-lg dark:border-gray-700">
        ...
        >
          <h1 class="font-semibold text-white">
            How do I ensure my online learning environment is secure and private?
          </h1>
          <span
            x-show="openItem !== 5"
            class="text-white bg-blue-500 rounded-full transition-all duration-200"
        ...
        <p
          ...
          class="p-8 text-sm text-gray-300"
        >
          Use strong, unique passwords for your accounts and enable two-factor authentication if available. Avoid sharing personal information or sensitive data in online forums or messages. Ensure your device has updated antivirus software and is secure from unauthorized access.
        </p>
      </div>
...
<div class="bg-gradient-to-r from-purple-400 via-purple-700 to-purple-600 py-12 flex justify-center mb-12">
  <div class="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-8">
    ...
    <div class="flex items-center space-x-4 text-white">
      ...
      <span class="text-4xl font-semibold">Subscribe to Newsletter</span>
    </div>

    <!-- Input and Button -->
    <div class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0">
      <div class="flex flex-row w-full">
        <input type="email" placeholder="Enter your email address..." class="px-8 py-6 flex-grow rounded-l-2xl text-gray-700 focus:outline-none" />
        <button class="bg-purple-700 hover:bg-purple-800 p-6 rounded-r-2xl flex-shrink-0">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M22 2L11 13" />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M22 2L15 22l-4-9-9-4 18-7z" />
          </svg>
        </button>
      </div>
    </div>
    ...
    <div class="relative bg-deep-purple-accent-400">
      <svg class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16" preserveAspectRatio="none" viewBox="0 0 1440 54">
        <path fill="#7c3aed" d="M0 22L120 16.7C240 11 480 1.00001 720 0.700012C960 1.00001 1200 11 1320 16.7L1440 22V54H1320C1200 54 960 54 720 54C480 54 240 54 120 54H0V22Z"></path>
      </svg>
      ...
      <div class="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div class="md:max-w-md lg:col-span-2">
            <!-- <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
              ...
              <span class="ml-2 text-xl font-bold tracking-wide text-gray-100 uppercase">ProLearn VLE</span>
            </a>
        ...
        <div class="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
          <p class="text-sm text-gray-100">
            © Copyright 2024 ProLearn VLE. All rights reserved.
          </p>
    ...
    <!-- Back to Top Button -->
      ...
      style="position: fixed; bottom: 2rem; right: 2rem; background-color: #6d28d9; color: white; padding: 1rem; border-radius: 50%; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: background-color 0.3s, transform 0.3s;"
      onmouseover="this.style.backgroundColor='#5b21b6'; this.style.transform='scale(1.1)';"
      onmouseout="this.style.backgroundColor='#6d28d9'; this.style.transform='scale(1)';">
      ...
      <script>
          // JavaScript to handle button visibility and scrolling
